...
import { SessionUncheckedUpdateManyWithoutUserInput } from '../session/session-unchecked-update-many-without-user.input';

@InputType()
export class UserUncheckedUpdateWithoutGroupsInput {
    ...
    @Field(() => SessionUncheckedUpdateManyWithoutUserInput, {nullable:true})
